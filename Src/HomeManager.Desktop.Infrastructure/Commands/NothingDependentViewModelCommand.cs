...
{
    public class NothingDependentViewModelCommand
    {
        private NothingDependentViewModelCommand(
            IRegion region,
            IList newItems,
            IList oldItems,
        ...
        public NothingDependentViewModelCommand()
        {
        }
        ...
        public static NothingDependentViewModelCommand Create(
            IRegion region,
            IList newItems,
            IList oldItems,
            DependentViewModelActions action)
        {
            return new NothingDependentViewModelCommand(region, newItems, oldItems, action);
        }
    }
}
